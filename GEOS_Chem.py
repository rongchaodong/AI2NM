...
class GEOS_Chem_Model(CH4_Model):
    ...
    def _get_consumption(self):
        # add Memo model's consumption into here, since TEM consumption equals CarbonTracker's consumption
        memo_model = MeMo_Model("GEOS_Chem", "../bottom-up/MeMo_1990-2009_monthly_corrected.nc")
        consumption_ds = memo_model.dataset
...
if __name__ == '__main__':
    model = GEOS_Chem_Model("GEOS_Chem", "../top-down/geoschem_post_wetland.nc4", (4.0, 5.0))
    print(model.dataset)
    print(model.query((-45.0, -43.0), (45.0, 47.0), ("2011-11", "2012-2")))